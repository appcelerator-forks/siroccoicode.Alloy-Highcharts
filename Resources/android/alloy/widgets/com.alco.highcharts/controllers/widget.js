function WPATH(s) {
    ...
    var path = -1 === index ? "com.alco.highcharts/" + s : s.substring(0, index) + "/com.alco.highcharts/" + s.substring(index + 1);
...
function Controller() {
    ...
    new (require("alloy/widget"))("com.alco.highcharts");
    this.__widgetId = "com.alco.highcharts";
